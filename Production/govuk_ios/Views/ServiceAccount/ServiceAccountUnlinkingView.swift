...
struct ServiceAccountUnlinkingView: View {
    @StateObject private var viewModel: ServiceAccountUnlinkingViewModel

    init(viewModel: ServiceAccountUnlinkingViewModel) {
