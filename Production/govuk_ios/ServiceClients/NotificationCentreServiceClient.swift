...
protocol NotificationCentreServiceClientInterface {
    ...
    func fetchDetailedNotification(with id: String, callback: @escaping (DetailedNotification?) -> Void)
}
...
struct NotificationCentreServiceClient: NotificationCentreServiceClientInterface {
    ...
    func fetchDetailedNotification(with id: String, callback: @escaping (DetailedNotification?) -> Void) {
        callback(NotificationCentreViewModel.MockData.testDetailedNotifications.first(where: { // TODO Implement properly
