...
struct CustomerVehicleViewModelTests {
    ...
    func taxStatusViewModel_taxedUntilDateIsValid_formatsStatusCorrectly() {
        ...
        #expect(sut.taxStatusViewModel.statusInformation?.title == expectedStatusString)
    }
    ...
    func taxStatusViewModel_taxedUntilDateIsNil_returnsUnknown() {
        ...
        #expect(sut.taxStatusViewModel.statusInformation?.title == String(localized: .DVLA.valid))
    }
    ...
    func motStatusViewModel_motExpiryDateIsValid_formatsStatusCorrectly() {
        ...
        #expect(sut.motStatusViewModel.statusInformation?.title == expectedStatusString)
    }
    ...
    func motStatusViewModel_motExpiryDateIsNil_returnsUnknown() {
        ...
        #expect(sut.motStatusViewModel.statusInformation?.title == String(localized: .DVLA.motUnknown))
    }
